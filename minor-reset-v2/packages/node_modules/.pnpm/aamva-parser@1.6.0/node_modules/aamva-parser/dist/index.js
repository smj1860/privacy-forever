...
// src/mappers/v11/versionElevenFieldMapper.ts
var VersionElevenFieldMapper = class {
  constructor() {
    this.fields = {};
    const fieldMapper = new FieldMapper();
    this.fields = __spreadValues({}, fieldMapper.fields);
...
// src/mappers/v11/versionElevenFieldParser.ts
var VersionElevenFieldParser = class extends FieldParser {
  constructor(data) {
    super(data, new VersionElevenFieldMapper());
  }
};

// src/mappers/v12/versionTwelveFieldMapper.ts
var VersionTwelveFieldMapper = class {
  constructor() {
    this.fields = {};
    const fieldMapper = new FieldMapper();
    this.fields = __spreadProps(__spreadValues({}, fieldMapper.fields), {
      cdlIndicator: "DDM",
...
// src/mappers/v12/versionTwelveFieldParser.ts
var VersionTwelveFieldParser = class extends FieldParser {
  constructor(data) {
...
var License = class {
  constructor(data) {
    ...
    this.cdlIndicator = null;
    this.nonDomiciledIndicator = null;
    this.enhancedCredentialIndicator = null;
    this.permitIndicator = null;
    this.version = null;
    this.pdf417 = null;
...
function isUnder21(barcode) {
  const age = getAge(barcode);
  return age !== null && age < 21;
}
function isUnder18(barcode) {
  const age = getAge(barcode);
  return age !== null && age < 18;
}
function isAcceptable(barcode) {
  const license = parse(barcode);
...
function getState(barcode) {
  var _a;
  const license = parse(barcode);
  return (_a = license.state) != null ? _a : null;
}
function isCDL(barcode) {
  const license = parse(barcode);
